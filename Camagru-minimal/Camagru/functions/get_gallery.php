						...
						<div class='tile is-parent'>
							<figure class='image'>
									<a href='image_page.php?img=$img_id'>
										<img style='height:30%; width: 35%; border:2px solid #009f8b;' src='data:image/png;base64,".$img_name."' />
									</a>
							</figure>
							<p style='background: transparent; color:#009f8b; border-color: #009f8b;' class='subtitle'>$l_count Likes - $c_count Comments</p>
					  </div>
					</div>
				</div>";
	}
