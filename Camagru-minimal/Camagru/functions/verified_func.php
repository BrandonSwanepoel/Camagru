...
function verify()
{
    ...
    if (isset($_GET['ver_key'])) {
        ...
        if ($user_data['verified'] == 1) {
            ...
            echo "<p style=\"color:#009f8b; font-size:20px; margin-top: 10%\">Your Account has been verified. You may now login!</p>";
        }
        else if (!$user_data)
        {
            echo "<p style=\"color:#009f8b; font-size:20px; margin-top: 10%\">No Account could be found</p>";
        }
    } else {
        echo "<p style=\"color:#009f8b; font-size:20px; margin-top: 10%\">No verification code found! Please click the link in your email!</p>";
    }
}
?>